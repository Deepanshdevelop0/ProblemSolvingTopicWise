...
//        System.out.println("result 2 : " + res2);
        ...
        double res3 = classObj.findMedianSortedArraysRevise(new int[]{1, 2}, new int[]{3, 4, 5});
    ...
    public double findMedianSortedArraysRevise(int[] nums1, int[] nums2) {
        int n = nums1.length, m = nums2.length;

        if (n > m) {
            return findMedianSortedArraysRevise(nums2, nums1);
        }
